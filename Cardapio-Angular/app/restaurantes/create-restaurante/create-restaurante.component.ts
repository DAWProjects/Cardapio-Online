...
// ------------------Time Picker-------------------
    ...
    public add( nome: string, numero: number, telefone: number, username: string, email: string, password: string, av_rua: string, card_img: string, logo: string, estado: Estado_Restaurante, lat:number, long:number): void {
         this.creating = true;
