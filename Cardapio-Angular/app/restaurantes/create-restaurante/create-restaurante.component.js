...
var CreateRestauranteComponent = (function () {
    ...
    ;
    CreateRestauranteComponent.prototype.add = function (nome, telefone, cidade, av_rua, numero, lat, long, imagem) {
        // this.creating = true;
        // this.utilizador= new Utilizador(username, email, password);
        this.restaurante = new index_1.Restaurante(nome, telefone, cidade, av_rua, numero, lat, long, imagem, imagem, 1, 1);
        // this.utilizadorService.create(this.utilizador);
        this.restauranteService.create(this.restaurante).then(this.voltar);
    };
    CreateRestauranteComponent.prototype.voltar = function () {
        window.history.back();
    };
    ;
    __decorate([
